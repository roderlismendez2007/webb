...
<div class="col-xs-12">
    ...
    <a class="btn btn-success" href="../index.php">Nuevo usuario  </a>
      <a class="btn btn-danger" href="/prof/EditarTabla.php">Tabla de pacientes </a>
      <a class="btn btn-warning" href="../includes/_sesion/cerrarSesion.php">Iniciar sesion</a>
...
$SQL="SELECT user.id, user.nombre, user.password, user.telefono,
 permisos.rol FROM user
